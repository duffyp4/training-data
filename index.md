...
<div class="calendar-widget">
    ...
    <div class="calendar-grid">
        ...
        <div class="calendar-day has-data" onclick="window.location.href='data/2025/07/25.md'">
        ...
        <div class="calendar-day has-data" onclick="window.location.href='data/2025/07/27.md'">
            <span class="day-number">27</span>
            <div class="day-dots"><span class="dot wellness-dot">🔵</span></div>
        </div>
        <div class="calendar-day has-data" onclick="window.location.href='data/2025/07/28.md'">
